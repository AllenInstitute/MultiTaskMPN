...
def main():
    ...
    parser.add_argument("--no-fixed-points", action="store_true",
                        help="Pass --no-fixed-points to the analysis step, skipping "
                             "the time-consuming gradient fixed-point solvers.")
